        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-profile mb-4">
              <div class="card-header" style="background-image: url(https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/photos/paul-morris-116514-unsplash.jpg);"> </div>
              <div class="card-body text-center"><img class="card-profile-img" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-7.jpg" alt="Nathan Andrews">
            ...
            <div class="card mb-4">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-7.jpg" alt="Nathan Andrews"></div>
            ...
            <form class="card mb-4">
              ...
              <div class="card-body">
                <div class="row mb-3">
                  <div class="col-auto d-flex align-items-center"><img class="avatar avatar-lg p-1" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-7.jpg" alt="Avatar"></div>
                  <div class="col">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ps-3"><small class="float-right">10 mins ago</small>
                      ...
                      <div class="d-flex mt-4">
                        <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-3.jpg" alt="Serenity Mitchelle"></div>
                      ...
                      <div class="d-flex mt-4">
                        <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-1.jpg" alt="Tony O'Brian"></div>
                        <div class="flex-grow-1 ps-3 text-sm text-muted"><strong class="text-dark">Tony O'Brian: </strong>His room, a proper human room although a little too small, lay peacefully between its four familiar walls. A collection of textile samples lay spread out on the table.</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="list-group-item border-start-0 border-end-0 py-5">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ps-3"><small class="float-right">34 mins ago</small>
                      ...
                      <div class="d-flex mt-4">
                        <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="https://d19m59y37dris4.cloudfront.net/bubbly/1-2/img/avatar-6.jpg" alt="Javier Gregory"></div>
                        <div class="flex-grow-1 ps-3 text-sm text-muted"><strong class="text-dark">Javier Gregory: </strong>One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections</div>
                      </div>
                    </div>
                  </div>
                </div>
